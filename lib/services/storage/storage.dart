...
class GStorage {
  ...
  /// Compatibility accessor: fork code (and pre-refactor upstream callers)
  /// still reads the raw Hive box directly. Kept public alongside the typed
  /// SettingsKeys API until all call sites migrate to getSetting/putSetting.
